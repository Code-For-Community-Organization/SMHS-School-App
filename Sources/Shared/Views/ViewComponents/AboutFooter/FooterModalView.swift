...
struct FooterModalView: View {
    ...
    Toggling on will display schedules
    in a plain text style instead of formated blocks.
    Legacy schedule style sometimes might be more reliable
    and detailed (eg. sports).
"""
            ...
            SettingsView {
                ...
                Section(header: Label("Statements", systemSymbol: .infoCircle).textCase(nil)) {
                    ...
                    Link("Terms and Conditions",
                         destination: URL(string: "https://smhs-schedule.flycricket.io/terms.html")!)
                    Link("Privacy Policy",
                         destination: URL(string: "https://smhs-schedule.flycricket.io/privacy.html")!)
                }
                Section {
