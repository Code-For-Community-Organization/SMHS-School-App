            ...
            VStack {
                ...
                VStack(spacing: 35) {
                    ...
                    OnboardingRowItem(title: "Campus News",
                                      ...
                                      symbolImage: Image(systemSymbol: .newspaperFill).foregroundColor(.secondary).font(.system(size: 40)))
                    OnboardingRowItem(title: "Nutrition Schedule",
                                      description: "Use a segmented toggle to easily switch between 1st or 2nd lunch.",
                                      symbolImage: Image(systemSymbol: .calendarCircleFill).foregroundColor(.primary).font(.system(size: 50)))
                    ...
                    OnboardingRowItem(title: "Search Bar",
                                      ...
                                      symbolImage: Image(systemSymbol: .magnifyingglassCircleFill).foregroundColor(.primary).font(.system(size: 50)))
                    ...
                    OnboardingRowItem(title: "Open Source",
                                      ...
                                      symbolImage: Image(systemSymbol: .chevronLeftSlashChevronRight).foregroundColor(.primary).font(.system(size: 40)),
