...
struct InformationCard: Identifiable {
    ...
    static let informationCards = [InformationCard(title: "Eagle Eats", backgroundColor: Color.systemPink, link: URL(string: "https://www.smhs.org/campus-life/dining")!, image: Image("food")),
                                   ...
                                   InformationCard(title: "Speak Up!", backgroundColor: Color.secondary, link: URL(string: "https://www.smhs.org/other/speak-up")!, image: Image(uiImage: #imageLiteral(resourceName: "Speakup"))),
                                   InformationCard(title: "School Calendar", backgroundColor: Color.systemPurple, link: URL(string: "https://www.smhs.org/other/full-school-calendar")!, image: Image(uiImage: #imageLiteral(resourceName: "Calendar"))),
