...
struct InformationCard: Identifiable {
    ...
    static let informationCards = [InformationCard(title: "Eagle Eats", backgroundColor: Color.systemPink, link: URL(string: "https://www.smhs.org/campus-life/dining")!, image: Image("food")),
                                   ...
                                   InformationCard(title: "Health & Safety", backgroundColor: appSecondary, link: URL(string: "https://www.smhs.org/other/update-center")!, image: Image(uiImage: #imageLiteral(resourceName: "COVID-19"))),
                                   InformationCard(title: "Speak Up!", backgroundColor: appSecondary, link: URL(string: "https://www.smhs.org/other/speak-up")!, image: Image(uiImage: #imageLiteral(resourceName: "Speakup"))),
